...
def unet_model(inL, outL):
    ...
    conv1 = Conv2D(d1, (3, 3), padding='valid', kernel_initializer='glorot_normal')(inp1)
    conv1 = BatchNormalization(momentum=b_momentum)(conv1)  # note that default bs=8 might be small for BN.
    #                                                         maybe try group norm.
    conv1 = ReLU()(conv1)
    conv1 = Conv2D(d1, (3, 3), padding='valid', kernel_initializer='glorot_normal')(conv1)
    conv1 = BatchNormalization(momentum=b_momentum)(conv1)
    conv1 = ReLU()(conv1)
    pool1 = MaxPooling2D(pool_size=(2, 2))(conv1)

    conv2 = Conv2D(d2, (3, 3), padding='valid', kernel_initializer='glorot_normal')(pool1)
    conv2 = BatchNormalization(momentum=b_momentum)(conv2)
    conv2 = ReLU()(conv2)
    conv2 = Conv2D(d2, (3, 3), padding='valid', kernel_initializer='glorot_normal')(conv2)
    conv2 = BatchNormalization(momentum=b_momentum)(conv2)
    conv2 = ReLU()(conv2)
    pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)

    conv3 = Conv2D(d3, (3, 3), padding='valid', kernel_initializer='glorot_normal')(pool2)
    conv3 = BatchNormalization(momentum=b_momentum)(conv3)
    conv3 = ReLU()(conv3)
    conv3 = Conv2D(d3, (3, 3), padding='valid', kernel_initializer='glorot_normal')(conv3)
    conv3 = BatchNormalization(momentum=b_momentum)(conv3)
    conv3 = ReLU()(conv3)
    pool3 = MaxPooling2D(pool_size=(2, 2))(conv3)

    conv4 = Conv2D(d4, (3, 3), padding='valid', kernel_initializer='glorot_normal')(pool3)
    conv4 = BatchNormalization(momentum=b_momentum)(conv4)
    conv4 = ReLU()(conv4)
    conv4 = Conv2D(d4, (3, 3), padding='valid', kernel_initializer='glorot_normal')(conv4)
    conv4 = BatchNormalization(momentum=b_momentum)(conv4)
    conv4 = ReLU()(conv4)
    pool4 = MaxPooling2D(pool_size=(2, 2))(conv4)

    convJ = SeparableConv2D(d5, (3, 3), padding='valid', kernel_initializer='glorot_normal')(pool4)
    convJ = BatchNormalization(momentum=b_momentum)(convJ)
    convJ = ReLU()(convJ)
    convJ = SeparableConv2D(d5, (3, 3), padding='valid', kernel_initializer='glorot_normal')(convJ)
    convJ = BatchNormalization(momentum=b_momentum)(convJ)
    convJ = ReLU()(convJ)
    ...
    conv5 = Conv2D(d4, (3, 3), padding='valid', kernel_initializer='glorot_normal')(merge5)
    conv5 = BatchNormalization(momentum=b_momentum)(conv5)
    conv5 = ReLU()(conv5)
    conv5 = Conv2D(d4, (3, 3), padding='valid', kernel_initializer='glorot_normal')(conv5)
    conv5 = BatchNormalization(momentum=b_momentum)(conv5)
    conv5 = ReLU()(conv5)
    ...
    conv6 = Conv2D(d3, (3, 3), padding='valid', kernel_initializer='glorot_normal')(merge6)
    conv6 = BatchNormalization(momentum=b_momentum)(conv6)
    conv6 = ReLU()(conv6)
    conv6 = Conv2D(d3, (3, 3), padding='valid', kernel_initializer='glorot_normal')(conv6)
    conv6 = BatchNormalization(momentum=b_momentum)(conv6)
    conv6 = ReLU()(conv6)
    ...
    conv7 = Conv2D(d2, (3, 3), padding='valid', kernel_initializer='glorot_normal')(merge7)
    conv7 = BatchNormalization(momentum=b_momentum)(conv7)
    conv7 = ReLU()(conv7)
    conv7 = Conv2D(d2, (3, 3), padding='valid', kernel_initializer='glorot_normal')(conv7)
    conv7 = BatchNormalization(momentum=b_momentum)(conv7)
    conv7 = ReLU()(conv7)
    ...
    conv8 = Conv2D(d1, (3, 3), padding='valid', kernel_initializer='glorot_normal')(merge8)
    conv8 = BatchNormalization(momentum=b_momentum)(conv8)
    conv8 = ReLU()(conv8)
    conv8 = Conv2D(d1, (3, 3), padding='valid', kernel_initializer='glorot_normal')(conv8)
    conv8 = BatchNormalization(momentum=b_momentum)(conv8)
    conv8 = ReLU()(conv8)
